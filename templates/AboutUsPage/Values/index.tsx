...
const list = [
    {
        title: "We make a complete study of your project with a well defined plan",
        status: "CONSULTING",
        color: "#EB5BE5",
    },
    {
        title: "We develop your project from A to Z with the latest technologies ",
        status: "DEVELOPMENT",
        color: "#6F5BEB",
    },
    {
        title: "We create hype around your project within the crypto community",
        status: "MARKETING",
        color: "#89EB5B",
    },
];
            ...
            <div className={styles.row}>
                <div className={styles.col}>
                    ...
                    <div className={styles.content}>
                        ChainGrowth believes in Web3 for all. ChainGrowth is a decentralised
