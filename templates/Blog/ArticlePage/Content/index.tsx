        ...
        <div className={cn("container", styles.container)}>
            ...
            >
                <div className={styles.caption}>
                    Everything ChainGrowth weekly report
                </div>
            ...
            <div className={cn("content", styles.content)}>
                <section>
                    ...
                    <p>
                        ChainGrowth is committed to fostering the growth of Web3
                ...
                <section>
                    <h2>Everything ChainGrowth weekly report</h2>
                    <h3>Built by developers, for developers.</h3>
                    <p>
                        ChainGrowth is committed to fostering the growth of Web3
                        applications by providing the infrastructure and
                        security needed for Web3. “ChainGrowth accelerated our
